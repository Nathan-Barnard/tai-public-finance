...
- [`RUN-20260901T230703Z-CS001-ATLAS-ee48affe-01.yaml`](RUN-20260901T230703Z-CS001-ATLAS-ee48affe-01.yaml) — CS001 joint productivity-automation shock atlas: one standardized joint Brownian innovation over the full direction circle (5-degree grid plus every analytically constructed direction, both signs), matched deterministic and one-year OU displacement families, and a persistence-unravelling experiment; 438 paths, all independent checks passed. See `../outputs/cs001-joint-shock-atlas-20260901T230702Z/MORNING_REPORT.md`; large raw tables are hash-referenced, not committed.
